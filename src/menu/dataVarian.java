 ...
 * @author user
 */
public class dataVarian extends javax.swing.JDialog {
    ...
    public dataVarian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataVarian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dataVarian dialog = new dataVarian(new javax.swing.JFrame(), true);
        ...
        try {
           ...
           try (PreparedStatement st = conn.prepareStatement(sql)) {
               ...
               while (rs.next()) {
                    ...
                    Object[] rowData = {idVarian, namaVarian, stokVarian, satuan, hargaPerSatuan};
    ...
    private void pilihData(){
        ...
        id_varian       = tblData.getValueAt(row, 0).toString();
        nama_varian     = tblData.getValueAt(row, 1).toString();
        stok_varian     = tblData.getValueAt(row, 2).toString();
