 ...
 * @author user
 */
public class menuLaporanBahan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pembelian", "Tgl Pembelian", "Nama Bahan", "Jumlah", "Satuan", "Harga Beli", "Petugas"
            }
        ));
        ...
        databahan1.setText("Menu Laporan Pembelian Bahan");
    ...
    try {
            ...
            String reportPath = "src/report/bahanLaporan.jasper"; 
    ...
    private int getTotalData(){
        ...
        try {
            String sql = "SELECT COUNT(*) AS total FROM pembelian_bahan WHERE tgl_pembelian BETWEEN ? AND ?\n";
    ...
    try {
        ...
        String sql = "SELECT \n" +
                     ...
                     "INNER JOIN pembelian_bahan pb ON pb.id_pembelian_bahan = dpb.id_pembelian_bahan\n" +
                     "INNER JOIN bahan b ON b.id_bahan = dpb.id_bahan\n" +
                     "INNER JOIN user u ON u.id_user = pb.id_user\n" +
                     "WHERE pb.tgl_pembelian BETWEEN ? AND ?\n" +
                     "ORDER BY pb.id_pembelian_bahan ASC \n" +
                     "LIMIT ?,?";
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            st.setDate(1, java.sql.Date.valueOf(tanggalMulaiStr));
            st.setDate(2, java.sql.Date.valueOf(tanggalAkhirStr));
            ...
            while (rs.next()) {
                ...
                Object[] rowData = {idPembelianBahan, tanggalPembelian, namaBahan, jumlah, satuan, hargaBeli, namaPetugas};
                model.addRow(rowData);
            }
        }
    } catch (Exception e) {
        Logger.getLogger(menuLaporanBahan.class.getName()).log(Level.SEVERE, null, e);
    }
}
    ...
    try {
        String sql = "SELECT \n" +
                     ...
                     "INNER JOIN bahan b ON b.id_bahan = dpb.id_bahan\n" +
                     "INNER JOIN user u ON u.id_user = pb.id_user\n" +
                     "WHERE pb.id_pembelian_bahan LIKE ? OR pb.tgl_pembelian LIKE ? OR b.nama_bahan LIKE ? OR\n" +
                     "dpb.jumlah LIKE ? OR dpb.satuan LIKE ? OR dpb.harga_beli LIKE ? OR u.nama LIKE ?" +
                     "ORDER BY pb.id_pembelian_bahan ASC";
        try (PreparedStatement st = conn.prepareStatement(sql)) {
