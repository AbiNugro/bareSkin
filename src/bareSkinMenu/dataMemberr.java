 ...
 * @author user
 */
public class dataMemberr extends javax.swing.JDialog {
    ...
    public dataMemberr(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataMemberr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dataMemberr dialog = new dataMemberr(new javax.swing.JFrame(), true);
    ...
    private int getTotalData(){
        ...
        try {
            ...
            Logger.getLogger(dataMemberr.class.getName()).log(Level.SEVERE,null, e);
        }
        ...
        try {
           ...
           try (PreparedStatement st = conn.prepareStatement(sql)) {
               ...
               while (rs.next()) {
                    ...
                    String nomor = rs.getString("no_telepon");
                    String poin = rs.getString("poin");

                    Object[] rowData = {idMember, namaMember, alamat, nomor, poin};
    ...
    try {
        String sql = "SELECT * FROM member WHERE id_member LIKE ? OR nama_member LIKE ? OR alamat LIKE ? OR "
                + "no_telepon LIKE ? OR poin LIKE ?";
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                String poin = rs.getString("poin");
                Object[] rowData = {idMember, namaMember, alamat, no_telepon, poin};
                model.addRow(rowData);
            }
        }
    } catch (Exception e) {
